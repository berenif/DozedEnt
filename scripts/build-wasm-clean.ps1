...
# Usage: .\scripts\build-wasm-clean.ps1 [dev|prod|host|all]

param(
    [Parameter(Position=0)]
    [ValidateSet('dev', 'prod', 'host', 'all', '')]
    [string]$BuildType = 'prod'
)

Write-Host "🛠️  WASM Build Script for DozedEnt Game" -ForegroundColor Cyan
